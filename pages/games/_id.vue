<template>
  <div>
    <div class="bg-gray-800 hero" :style="`background:url(${backgroundImage}); background-size:cover`">
      <div class="container flex flex-col items-end pb-8 mx-auto md:flex-row" style="height:350px">
    ...
    <div class="container flex flex-col mx-auto md:flex-row">
      <div class="w-full -mt-16 md:w-1/4">
      ...
      <div class="w-full py-8 leading-normal md:w-3/4 md:ml-12">
        <p class="mb-12">{{ game.summary }}</p>

        <div class="flex flex-wrap -mx-4">
          <a href="#" v-for="screenshot in game.screenshots" :key="screenshot.cloudinary_id" class="w-full px-4 mb-12 no-underline md:w-1/4">
